...
def main():
    ...
    bounding_boxes, landmarks = detect_faces(image, min_face_size, pnet, rnet, onet, thresholds, nms_thresholds, height, width, device)
    visualize_results(image, bounding_boxes, landmarks)
